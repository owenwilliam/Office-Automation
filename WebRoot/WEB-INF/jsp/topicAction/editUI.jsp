...
<head>
  ...
  　<%@ include file="/WEB-INF/jsp/public/commons.jspf" %>
	<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/blue/forum.css" />
...
<div id="MainArea">
		...
		<s:form action="topic_edit" cssStyle="margin: 0; padding: 0;">
	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<%--<a href="${pageContext.request.contextPath}/BBS_Forum/forumShow.html">${forum.name}</a>
				--%><s:a action="forum_show?id=%{#topic.forum.id}">${forum.name}</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				发表新主题
			</div>
		</div>
		<div class="ItemBlockBorder">
			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					...
					<s:textfield cssClass="InputStyle" name="title"></s:textfield>
						</div>
				...
				<tr height="240">
					...
					<td class="InputAreaBg"><s:textarea name="content" cssStyle="width:650px;height:200px"></s:textarea></td>
				</tr>
				<tr height="30">
