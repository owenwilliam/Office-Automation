...
<html>
<head>
	<title>查看主题的回复：${topic.title}</title>
...
<div id="MainArea">
	...
	<s:form action="reply_add?topicId=%{#topic.id}" cssStyle="margin: 0; padding: 0;">
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
						<s:textfield name="title" cssClass="InputStyle" cssStyle="width:100%" value="回复：%{#topic.title}"/>
					</td>
				</tr>
