        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="template_download?id=%{applicationTemplateId}" cssStyle="text-decoration: underline">[点击下载文档模板文件]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><input type="file" name="upload" class="InputStyle {required:true, accept:'.doc'}" style="width:450px;" /> *</td>
                    </tr>
                </table>
            </div>
        </div>
